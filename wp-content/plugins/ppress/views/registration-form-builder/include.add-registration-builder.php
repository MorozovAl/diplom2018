...
<p>
[reg-submit value="Регистрация" class="submit" id="submit-button"]
</p>
						...
						<div class="inside">
							<table class="form-table">
								...
								<tr>
									...
									<td>
										<textarea name="rfb_success_registration" id="message_success"><?php echo isset( $_POST['rfb_success_registration'] ) ? $_POST['rfb_success_registration'] : '<div>Регистрация прошла успешно</div>'; ?></textarea>
